					...
					<div class="container">
						...
						<div class="collapse navbar-collapse" id="exCollapsingNavbar">
							...
							<ul class="nav navbar-nav">
								...
								<li class="nav-item"><a href="{{ url('/uteis') }}" class="nav-link">Links Úteis</a></li>
							...
							<ul class="nav navbar-nav flex-row justify-content-between ml-auto">
								<li class="dropdown order-1">
									<a id="dropdownMenu1" data-toggle="dropdown" class="btn btn-link dropdown-toggle text-decoration-none text-light">
										<i class="fas fa-user"></i> Entrar <span class="caret"></span>
									</a>
									<ul class="dropdown-menu dropdown-menu-right mt-2">
										<li class="px-3 py-2">
											<form class="form" role="form">
												<div class="form-group">
													<input id="emailInput" placeholder="Email" class="form-control " type="text" required="">
												</div>
												<div class="form-group">
													<input id="passwordInput" placeholder="Senha" class="form-control " type="text" required="">
												</div>
												<div class="form-group">
													<button type="submit" class="btn btn-primary btn-block">Entrar</button>
												</div>
												<div class="form-group text-center">
													<a href="{{ route('acesso.buscarpessoa') }}">Cadastrar Usuário</a>
												</div>
												<div class="form-group text-center">
													<a href="#" data-toggle="modal" data-target="#modalPassword">Esqueceu a senha?</a>
												</div>
											</form>
										</li>
									</ul>
