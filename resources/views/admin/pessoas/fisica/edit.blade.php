                    ...
                    <div class="form-row">
                        ...
                        <div class="col-2">
                            ...
                            <select id="sexo" 
                                name="sexo"
                                class="form-control">
                                <option value="{{ $lista_pessoa->sexo }}" class="bg-info">{{ $lista_pessoa->sexo }}</option>
                        ...
                        <div class="col-4">
                            ...
                            <select id="escolaridade" 
                                name="escolaridade"
                                class="form-control">
                                <option value="{{ $lista_pessoa->escolaridade }}" class="bg-info">{{ $lista_pessoa->escolaridade }}</option>
                                <option value="Não Informado">Não Informado</option>
                    ...
                    <div class="form-row">
                        <div class="col-2">
                            ...
                            <select id="tp_sangue" 
                                name="tp_sangue"
                                class="form-control">
                                <option value="{{ $lista_pessoa->tp_sangue }}" class="bg-info">{{ $lista_pessoa->tp_sangue }}</option>
