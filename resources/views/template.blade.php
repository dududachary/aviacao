...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <style>
          ...
          .navbar-custom, .footer-copyright {
            background-color: rgb(46, 81, 109);
          }

          .head-footer {
            background-color: rgba(46, 81, 109, 0.8);
            color: rgb(255, 255, 255);
          }

          .navbar-custom .navbar-brand,
          .navbar-custom .navbar-text, .footer-copyright {
            color: rgba(255,255,255,.8);
          }
          /* change the link color */
          .navbar-custom .navbar-nav .nav-link, .footer-copyright {
            color: rgba(255,255,255,.5);
          }
          /* change the color of active or hovered links */
          .navbar-custom .nav-item.active .nav-link,
          .navbar-custom .nav-item:hover .nav-link, .footer-copyright {
            color: #ffffff;
          }
        </style>
